...
async def test_calculate_sma(calculator, sample_stock_data):
    ...
    indicators = await calculator.calculate_for_data(sample_stock_data, ["SMA_20"])
...
async def test_calculate_rsi(calculator, sample_stock_data):
    ...
    indicators = await calculator.calculate_for_data(sample_stock_data, ["RSI_14"])
...
async def test_calculate_macd(calculator, sample_stock_data):
    ...
    indicators = await calculator.calculate_for_data(sample_stock_data, ["MACD"])
...
async def test_calculate_bollinger_bands(calculator, sample_stock_data):
    ...
    indicators = await calculator.calculate_for_data(sample_stock_data, ["BB_20"])
...
async def test_calculate_volume_sma(calculator, sample_stock_data):
    ...
    indicators = await calculator.calculate_for_data(
        sample_stock_data, ["VOLUME_SMA_20"]
    )
...
async def test_insufficient_data(calculator):
    ...
    indicators = await calculator.calculate_for_data(stock_data, ["SMA_50"])
...
async def test_indicator_value_model():
    ...
    value = IndicatorValue(date=date(2024, 1, 1), values={"SMA": 100.5, "signal": None})
