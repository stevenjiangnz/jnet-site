...
class CacheKeys:
    ...
    @staticmethod
    def daily_data(symbol: str, start_date: Optional[date] = None, end_date: Optional[date] = None) -> str:
        """
    ...
    @staticmethod
    def weekly_data(symbol: str, start_date: Optional[date] = None, end_date: Optional[date] = None) -> str:
        """
