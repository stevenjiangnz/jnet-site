...
class DataFetcher:
    ...
    def _check_rate_limit(self):
        ...
        if self._call_count >= settings.rate_limit_calls:
            sleep_time = settings.rate_limit_period - (current_time - self._last_call_time)
            if sleep_time > 0:
    ...
    def fetch_stock_data(
        ...
        try:
            ...
            if df.empty:
                ...
                raise DataFetchError(f"No data available for {symbol} in the specified date range")
