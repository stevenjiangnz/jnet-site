...
class SymbolSummary(BaseModel):
    ...
    has_weekly: bool = Field(
        default=False, description="Whether weekly data is available"
    )
    last_updated: datetime = Field(
        ..., description="When this symbol data was last updated"
    )
...
class DataCatalog(BaseModel):
    ...
    symbols: List[SymbolSummary] = Field(
        default_factory=list, description="Symbol summaries"
    )
