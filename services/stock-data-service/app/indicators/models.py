...
class IndicatorData(BaseModel):
    ...
    category: str = Field(description="Category: trend, momentum, volatility, or volume")
    ...
    values: List[IndicatorValue] = Field(
        ...
        description="Time series of indicator values"
    )
    ...
    def get_value_at_date(self, target_date: date) -> Optional[Dict[str, Optional[float]]]:
